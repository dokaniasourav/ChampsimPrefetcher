...
clean: 
	...
	$(RM) inc/ooo_cpu_modules.inc
	 ...
	 find prefetcher/ppf_next_line_5 -name \*.o -delete
	 find prefetcher/ppf_next_line_5 -name \*.d -delete
...
bin/champsim: $(patsubst %.cc,%.o,$(wildcard src/*.cc)) obj/repl_rreplacementDlru.a obj/pref_pprefetcherDno.a obj/pref_pprefetcherDno_instr.a obj/pref_pprefetcherDppf_next_line_5.a obj/bpred_bbranchDbimodal1.a obj/btb_bbtbDbasic_btb.a
...
prefetcher/ppf_next_line_5/%.o: CFLAGS += -Iprefetcher/ppf_next_line_5
prefetcher/ppf_next_line_5/%.o: CXXFLAGS += -Iprefetcher/ppf_next_line_5
prefetcher/ppf_next_line_5/%.o: CXXFLAGS +=  -Dprefetcher_initialize=pref_pprefetcherDppf_next_line_5_initialize -Dprefetcher_cache_operate=pref_pprefetcherDppf_next_line_5_cache_operate -Dprefetcher_cache_fill=pref_pprefetcherDppf_next_line_5_cache_fill -Dprefetcher_cycle_operate=pref_pprefetcherDppf_next_line_5_cycle_operate -Dprefetcher_final_stats=pref_pprefetcherDppf_next_line_5_final_stats -Dl1d_prefetcher_initialize=pref_pprefetcherDppf_next_line_5_initialize -Dl2c_prefetcher_initialize=pref_pprefetcherDppf_next_line_5_initialize -Dllc_prefetcher_initialize=pref_pprefetcherDppf_next_line_5_initialize -Dl1d_prefetcher_operate=pref_pprefetcherDppf_next_line_5_cache_operate -Dl2c_prefetcher_operate=pref_pprefetcherDppf_next_line_5_cache_operate -Dllc_prefetcher_operate=pref_pprefetcherDppf_next_line_5_cache_operate -Dl1d_prefetcher_cache_fill=pref_pprefetcherDppf_next_line_5_cache_fill -Dl2c_prefetcher_cache_fill=pref_pprefetcherDppf_next_line_5_cache_fill -Dllc_prefetcher_cache_fill=pref_pprefetcherDppf_next_line_5_cache_fill -Dl1d_prefetcher_final_stats=pref_pprefetcherDppf_next_line_5_final_stats -Dl2c_prefetcher_final_stats=pref_pprefetcherDppf_next_line_5_final_stats -Dllc_prefetcher_final_stats=pref_pprefetcherDppf_next_line_5_final_stats
obj/pref_pprefetcherDppf_next_line_5.a: $(patsubst %.cc,%.o,$(wildcard prefetcher/ppf_next_line_5/*.cc)) $(patsubst %.c,%.o,$(wildcard prefetcher/ppf_next_line_5/*.c))
	@mkdir -p $(dir $@)
	ar -rcs $@ $^
...
-include $(wildcard prefetcher/ppf_next_line_5/*.d)
